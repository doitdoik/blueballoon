...
<body>
<form action="/blueballoon/accom/update" id="updateForm" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="stayCanCap" class="stayCanCap" value="${detail.stay.stayCanCap }"/>
			<input type="hidden" name="memBrand" class="memBrand" value="${detail.memBrand}"/>			
			...
			<table  id="rightContent">
				...
				<tr>
					...
					<tr class="api">
						...
						<input type="text" id="accomAddr" name="accomAddr" class="results" placeholder="${detail.accomAddr}">
				...
				<tr>
					...
					<td class="second">
					<textarea id="accomWeekPrice" name="accomWeekPrice" class="results" ><c:out value="${detail.accomWeekPrice}"/></textarea>
					</td>
				</tr>
				<tr>
					<td class="first">주말가격</td>
					<td class="second">
					<textarea id="accomWkndPrice" name="accomWkndPrice" class="results" ><c:out value="${detail.accomWkndPrice}"/></textarea>
					</td>
				</tr>
				<tr>
					<td class="first">최대수용인원</td>
					<td class="second">
						<textarea id="accomMaxCap"  class="results" ><c:out value="${detail.accomMaxCap}" /></textarea>
					</td>
				</tr>
				<tr>
					...
					<td class="second">
						<select id="stayCanCap">
							<option selected="selected" disabled="disabled">회원 전용 옵션</option>
						</select>
					</td>
				</tr>
				<tr>
			...
			<div>
				...
				<button class="btn" id="updateBtn" name="updateBtn" >수정완료</button>
				
			</div>				
			<div>
			<textarea id="accomContent" name="accomContent" >${detail.accomContent}</textarea>
			</div>		
