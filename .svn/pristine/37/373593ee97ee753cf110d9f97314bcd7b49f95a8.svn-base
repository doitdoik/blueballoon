...
<body>
		<form action="/blueballoon/ship/write" id="writeForm"  method="post" enctype="multipart/form-data">
			<div id="title">선명<br> <input class="memBrand" name="shipName" id="shipName" >
			...
			<table id="rightContent">
				...
				<tr>
					...
					<td class="second" ><input type="text" value="${member.memBrand}" name="memBrand" readonly="readonly">
				</tr>
					<tr class="api">
						<td class="api" colspan="2">
							<input type="text" id="shipAddr" name="shipAddr" placeholder="주소" >
				...
				<tr>
					...
					<td class="second"><input type="text" id="shipWeekPrice" name="shipWeekPrice"/></td>
				</tr>
				<tr>
					<td class="first">주말가격</td>
					<td class="second"><input type="text" id="shipWkndPrice" name="shipWkndPrice"/></td>
				</tr>
				<tr>
					<td class="first">최대수용인원</td>
					<td class="second"><input type="text" id="shipMaxCap" name="shipMaxCap"/></td>
				</tr>
				<tr>
					<td class="first">출발시간</td>
					<td class="second"><input type="text" id="shipDeparture" name="shipDeparture"/></td>
				</tr>
			</table>			
			<div>
			<textarea id="shipContent" name="shipContent" placeholder="선박 내용 작성"></textarea>
			</div>		
