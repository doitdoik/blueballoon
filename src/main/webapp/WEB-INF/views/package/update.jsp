	...
	$("#payBtn").on("click",function(){
		...
		IMP.request_pay({
		    ...
		    if ( rsp.success ) {
				...
				// 별점을 처음 주려고 할 때 star 테이블에는 accomNum이 존재하지 않아
				// join이 안되기 때문에 임시로 번호만 넣어준다
				$.ajax({
						url:"/blueballoon/star/"+accomNum,
						data:"_csrf="+csrf+"&_method=put",
						method:'post',
						success:function(){
						}
					});
...
<body>
<form action="/blueballoon/package/update" method="post">
<div class="row">
	<div class="col-lg-6">
	<h1><input value="<c:out value="${detail.pkgName}"/>" id="pkgName" name="pkgName"></h1>
	</div>
</div>
<div id="pkgDetailTop">
	<div id="pkgDetailTopLeft">
		<div id="pkgDetailPic">
		<img src="http://www.brdo.co.kr/kor/images/contents/301.jpg" style="width: 550px; height: 500px;">
		</div>
	</div>
	...
	<p>주말출발</p>	
		...
		&nbsp;출발일 &nbsp;&nbsp;&nbsp;<input type="date" id="departure">&nbsp;
...
<a href="/blueballoon/package/list"><button type="button" class="btn btn-info" id="packageListBtn">목록</button></a>
