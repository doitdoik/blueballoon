...
<body>
	<security:authentication property="principal.username" />
		<form action="/blueballoon/attr/write"   id="writeForm"  method="post" enctype="multipart/form-data">
			<div id="title">제목<br> <textarea name="attrTitle" id="attrTitle" cols="30" rows="10"></textarea>
			...
			<div class="second">
				<div id="memId" class="memId" name="memId">
				
				</div>
			</div>
			<div>
			<textarea id="attrContent" name="attrContent" placeholder="명소 정보 작성"></textarea>
			</div>		
